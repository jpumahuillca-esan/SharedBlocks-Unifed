    ...
    <div class="container-fluid-o">
      ...
      <div class="oferta-grid" :style="{ gridTemplateColumns: ofertas.length === 1 ? '1fr' : 'repeat(2, 1fr)' }">
        ...
        >
          ...
          <AtomHeading :level="3" class="card-subtitle" v-if="item.subtitle">{{ item.subtitle }}</AtomHeading>
          <AtomText class="card-description" v-if="item.description">{{ item.description }}</AtomText>
