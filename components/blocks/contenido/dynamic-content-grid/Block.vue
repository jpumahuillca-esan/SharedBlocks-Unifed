    ...
    <div class="feed-grid-fluid-container">
      ...
      <div class="text-center-header">
        <div class="title-inline-block">
          <AtomHeading :level="2" class="main-section-title" v-if="title">{{ title }}</AtomHeading>
          <div class="absolute-tricolor-divider"></div>
        </div>
        <AtomText class="section-intro-paragraph" v-if="introText">
          {{ introText }}
        </AtomText>
      </div>
      ...
      <div class="dynamic-cards-grid-layout">
        ...
        >
          ...
          <div class="card-textual-body">
            ...
            <AtomHeading :level="3" class="card-core-title text-truncate-2">
              {{ item.titulo }}
            </AtomHeading>

            <AtomText class="card-excerpt-text text-truncate-3">
              {{ item.resumen }}
            </AtomText>
