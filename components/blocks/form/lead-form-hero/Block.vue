  ...
  >
    <div class="container position-relative z-index-2 h-100">
      ...
      <div class="row align-items-center min-vh-75">
        ...
        >
          <div class="form-wrapper">
            <div class="text-white text-start mb-4">
              <AtomHeading :level="2" class="mb-2 text-uppercase title-transform shadow-sm-text">
                {{ mainFormTitle }}
              </AtomHeading>
              <AtomText v-if="mainFormSubtitle" class="mb-0 text-white-50 small shadow-sm-text fw-medium" style="font-size: 0.95rem;">
                {{ mainFormSubtitle }}
              </AtomText>
            </div>
        ...
        >
          <AtomHeading :level="1" class="visually-hidden">
            {{ marketingTitle }}
          </AtomHeading>
