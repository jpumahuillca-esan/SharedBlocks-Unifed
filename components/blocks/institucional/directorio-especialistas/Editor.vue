...
const localData = ref({
  title: props.modelValue?.title || 'Encuentra a un Especialista', // 🔥 Adaptado por defecto
...
watch(() => props.modelValue, (newVal) => {
  ...
  if (JSON.stringify(newVal) !== JSON.stringify(localData.value)) {
    localData.value = {
      title: newVal.title || 'Encuentra a un Especialista',
  ...
  <div class="p-3">
      ...
      <div class="card-body">
        ...
        <div class="mb-2.5">
          ...
          <input type="text" v-model="localData.actionText" class="form-control form-control-sm fw-semibold"
            placeholder="Ej: Ver Todos los Especialistas">
        </div>
        ...
        <div class="mb-1">
          ...
          <input type="text" v-model="localData.actionUrl"
            ...
            placeholder="Ej: /especialistas o /red-tecnica">
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        ...
        <div class="mb-1">
          <label class="small text-muted mb-1 fw-bold">Límite Inicial de Especialistas</label>
          <select v-model="localData.limit" class="form-select form-select-sm fw-bold text-secondary">
            ...
            <option :value="4">4 Especialistas</option>
            <option :value="6">6 Especialistas</option>
            <option :value="8">8 Especialistas</option>
            <option :value="12">12 Especialistas</option>
          </select>
          <span class="x-small text-muted d-block mt-1">Determina cuántas fichas de especialistas cargará Fastify en primera instancia.</span>
        </div>
      </div>
    </div>
