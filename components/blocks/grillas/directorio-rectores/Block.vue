    ...
    <div>
      <div class="directorio-section__content">
        <header class="directorio-header">
          <AtomHeading :level="2" v-if="title" class="section-title">{{ title }}</AtomHeading>
          <AtomText v-if="introText" class="intro-text">{{ introText }}</AtomText>
        </header>
        ...
        <div v-else-if="items.length > 0" class="directorio-grid">
          ...
          >
            ...
            <div class="info-block">
              ...
              <AtomHeading :level="3" class="director-name">{{ persona.first_name }} {{ persona.last_name }}</AtomHeading>
