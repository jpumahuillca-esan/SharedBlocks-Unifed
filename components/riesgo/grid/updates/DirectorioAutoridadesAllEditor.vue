...
const localData = ref({
  ...
  actionText: props.modelValue?.actionText || 'Ver Más', // 🎯 NUEVO
  actionUrl: props.modelValue?.actionUrl || ''          // 🎯 NUEVO
});
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        ...
        <div class="mb-1">
          ...
          <span class="x-small text-muted d-block mt-1">Determina cuántas fichas de rectores/directores cargará Fastify en primera instancia.</span>
        </div>
      </div>
    </div>
