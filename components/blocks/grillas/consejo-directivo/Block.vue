...
<template>
  <div class="consejo-section">
    <div class="max-w-container">
      ...
      <!-- <AtomHeading :level="1" class="main-title" v-if="title">
        {{ title }}
      ...
      <div class="directorio-grid" v-if="directorio.length > 0">
        ...
        >
          ...
          <div class="card-body-content">
            <div>
              <AtomHeading :level="3" class="member-name">
                {{ miembro.nombre }}
              </AtomHeading>
              ...
              <AtomText class="member-institution">
                {{ miembro.institucion }}
              </AtomText>
            </div>
