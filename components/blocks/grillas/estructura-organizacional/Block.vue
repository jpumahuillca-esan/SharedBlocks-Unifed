...
<template>
  <section class="estructura-section">
    ...
    <div class="titulo-wrapper" v-if="title">
      <AtomHeading :level="2" class="titulo">{{ title }}</AtomHeading>
    ...
    <div class="diagrama-top">
      ...
      <div class="col-izquierda">
        <div class="nodo nodo-md">
          <AtomText class="nodo-titulo">Asamblea de Rectores</AtomText>
          <AtomText class="nodo-sub">(Rectores de las universidades miembros)</AtomText>
        </div>
        ...
        <div class="nodo nodo-md">
          <AtomText class="nodo-titulo">Consejo Directivo</AtomText>
          <AtomText class="nodo-sub">(3 Rectores elegidos como plancha de Gestión)</AtomText>
        </div>
        <div class="conector-v">
          <span class="linea-v" />
          <i class="ti ti-chevron-down flecha" aria-hidden="true" />
        ...
        <div class="nodo nodo-md" id="sec-tecnica">
          <AtomText class="nodo-titulo">Secretaría Técnica nacional</AtomText>
          <AtomText class="nodo-sub">(El secretario técnico del presidente de la Red)</AtomText>
        </div>
      </div>
      ...
      <div class="col-derecha">
        <div class="nodo nodo-sm nodo-dashed">
          <AtomText class="nodo-titulo">Consejo Consultivo</AtomText>
          <AtomText class="nodo-sub">(Expertos)</AtomText>
          <AtomText class="nodo-titulo mt-1">(Comité Técnico Nacional)</AtomText>
        </div>
        <div class="conector-v-sm">
          <span class="linea-v" />
        </div>
        <div class="nodo nodo-sm">
          <AtomText class="nodo-titulo">Comité de fortalecimiento</AtomText>
        </div>
        <div class="conector-v-sm">
          <span class="linea-v" />
        </div>
        <div class="nodo nodo-sm">
          <AtomText class="nodo-titulo">Comité de ética e integridad</AtomText>
        </div>
      </div>
    </div>
    ...
    <div class="universidades-grid" v-if="universidades.length > 0" :style="{ gridTemplateColumns: `repeat(${universidades.length}, 1fr)` }">
      ...
      >
        ...
        <div class="nodo nodo-uni">
          <AtomText class="nodo-titulo">{{ uni }}</AtomText>
        </div>
        <div class="conector-v-sm">
          <span class="linea-v" />
        ...
        <div class="nodo nodo-xs">
          <AtomText class="nodo-titulo">Rector</AtomText>
        </div>
        <div class="conector-v-sm">
          <span class="linea-v" />
          <i class="ti ti-chevron-down flecha-sm" aria-hidden="true" />
        ...
        <div class="nodo nodo-xs">
          <AtomText class="nodo-titulo">Secretario técnico designado</AtomText>
        </div>
        <div class="conector-v-sm">
          <span class="linea-v" />
          <i class="ti ti-chevron-down flecha-sm" aria-hidden="true" />
        ...
        <div class="nodo nodo-xs">
          <AtomText class="nodo-titulo">Comité técnico inter áreas designados</AtomText>
        </div>
      </div>
    </div>
