  ...
  <section class="documentacion-section" v-if="documentos.length > 0">
    <div class="container-fluid-d">
      ...
      <div class="header-block">
        <AtomHeading :level="2" class="main-title" v-if="title">{{ title }}</AtomHeading>
        <AtomText class="section-intro" v-if="introText">
          {{ introText }}
        </AtomText>
      </div>
      ...
      <div class="documentos-grid">
        ...
        >
          ...
          <AtomHeading :level="3" class="doc-title" v-if="doc.title">{{ doc.title }}</AtomHeading>
          <AtomText class="doc-institution" v-if="doc.institution">{{ doc.institution }}</AtomText>
          <AtomText class="doc-desc" v-if="doc.desc">{{ doc.desc }}</AtomText>
