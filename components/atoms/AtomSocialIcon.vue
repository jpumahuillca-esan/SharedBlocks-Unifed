...
/**
 * AtomSocialIcon — botón circular con glifo de marca en SVG inline
 * (ARCIS Design System, Elementos > Iconos Sociales).
 *
 * webunificada aclara por qué esto es SVG propio y no Lucide: "Lucide no
 * incluye logos de marca (Facebook, Instagram, LinkedIn, YouTube, X).
 * Estos 5 glifos van como SVG inline propio, no como dependencia de una
 * librería externa — es la práctica estándar en la mayoría de design
...
type SocialNetwork = 'facebook' | 'instagram' | 'linkedin' | 'youtube' | 'x';
...
<template>
  <a :class="classes" :href="href" :aria-label="icon.label">
