  ...
  <section v-if="lineamientos.length" class="lineamientos-section">
    <div class="lineamientos-section__surface">
      <header class="lineamientos-section__header">
        ...
        >
          <AtomHeading :level="2" class="lineamientos-section__title">
            {{ title }}
          </AtomHeading>
        </NuxtLink>

        <AtomHeading :level="2" v-else-if="title" class="lineamientos-section__title">
          {{ title }}
        </AtomHeading>

        <AtomText v-if="introText" class="lineamientos-section__intro">
          {{ introText }}
        </AtomText>
      </header>
      ...
      <div class="lineamientos-grid">
        ...
        >
          ...
          <div class="lineamiento-card__body">
            <AtomText v-if="item.texto" class="lineamiento-card__text">
              {{ item.texto }}
            </AtomText>
          </div>
        </article>
