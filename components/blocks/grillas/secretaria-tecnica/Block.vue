  ...
  <section class="secretaria-tecnica">
    <div class="secretaria-tecnica__shell">
      <div class="secretaria-tecnica__content">
        ...
        <AtomText v-if="description1" class="secretaria-tecnica__paragraph">
          {{ description1 }}
        </AtomText>
        ...
        <article v-if="leader" class="leader-card">
          ...
          <AtomHeading :level="3" class="leader-card__name">
            {{ leader.nombre }}
          </AtomHeading>
          ...
          <AtomText class="leader-card__institution">
            {{ leader.institucion }}
          </AtomText>
        ...
        <AtomText v-if="description2" class="secretaria-tecnica__paragraph secretaria-tecnica__paragraph--wide">
          {{ description2 }}
        </AtomText>
        ...
        <div v-if="comite.length > 0" class="committee-grid">
          ...
          >
            ...
            <div class="committee-card__info">
              ...
              <AtomHeading :level="4" class="committee-card__name">
                {{ miembro.nombre }}
              </AtomHeading>
