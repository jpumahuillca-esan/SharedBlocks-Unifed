  ...
  <section class="objectives-section">
    <div class="objectives-section__shell">
      <div class="objectives-section__panel">
        ...
        <AtomText v-if="introText" class="objectives-section__intro">
          {{ introText }}
        </AtomText>
        ...
        <div v-if="generalObjective" class="objective-general">
          ...
          <div class="objective-general__box">
            <AtomText class="objective-general__text">
              “{{ generalObjective }}”
            </AtomText>
          </div>
        </div>
      ...
      <div class="objectives-section__panel">
        <div v-if="objetivosEspecificos.length" class="specific-objectives">
          <article
            ...
            :class="`specific-objective--${(obj.color || 'azul').toLowerCase()}`"
          >
            ...
            <div class="specific-objective__box">
              <AtomText v-if="obj.text" class="specific-objective__text">
                {{ obj.text }}
              </AtomText>
            </div>
          </article>
...
.specific-objective {
  ...
  --objective-accent: #274e9d;
  --objective-border: #274e9d;
}

.specific-objective--azul {
  --objective-accent: #274e9d;
  --objective-border: #274e9d;
}

.specific-objective--rojo {
  --objective-accent: #e1113f;
  --objective-border: #e1113f;
}
...
.specific-objective__tag {
  ...
  background: #ffffff;
  border: 1.5px solid var(--objective-border);
  border-bottom: none;
...
.specific-objective__box {
  ...
  border-radius: 8px;
  background: var(--objective-accent);
...
/* 1 elemento en la última fila */
.specific-objective:last-child:nth-child(3n + 1) {
  grid-column: 3 / span 2;
}

/* 2 elementos en la última fila */
.specific-objective:nth-last-child(2):nth-child(3n + 1) {
  grid-column: 2 / span 2;
}

.specific-objective:last-child:nth-child(3n + 2) {
