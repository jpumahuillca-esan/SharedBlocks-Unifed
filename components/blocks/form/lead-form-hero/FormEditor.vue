...
// FormEditor.vue solo se renderiza dentro del panel de administración (front),
// nunca en public-site (los "*Editor.vue" son exclusivos del editor del CMS).
// Por eso aquí sí corresponde usar el store de autenticación propio de front
// en vez de una copia dentro de la librería compartida: un store de Pinia con
// router/tipos propios de front no es portable, no debería vivir en un
// paquete que también consume public-site.
