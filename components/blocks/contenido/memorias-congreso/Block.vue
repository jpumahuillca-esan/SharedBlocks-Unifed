  ...
  <section v-if="historialCongresos.length > 0" class="memorias-section">
    <div class="memorias-section__container">
      <header class="memorias-section__header">
        ...
        <AtomText v-if="introText" class="memorias-section__intro">
          {{ introText }}
        </AtomText>
      </header>
          ...
          <div class="congreso-block__surface">
            <div class="congreso-block__body">
              <aside class="congreso-block__left">
                ...
                <AtomHeading :level="3" class="congreso-block__event-name">
                  {{ bloque.eventName }}
                </AtomHeading>

                <AtomText class="congreso-block__description">
                  {{ bloque.description }}
                </AtomText>
              </aside>
                  ...
                  >
                    <template v-if="bloque.documentos.length <= 2">
                      ...
                      <div class="deliverable-mini-card__content">
                        ...
                        <AtomHeading :level="4" class="deliverable-mini-card__title">
                          {{ doc.titulo }}
                        </AtomHeading>
                      </div>
                    </template>
