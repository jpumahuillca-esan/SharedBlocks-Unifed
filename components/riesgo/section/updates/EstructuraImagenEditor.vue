  ...
  <div class="p-3">
    ...
    <div class="card mb-3 border-0 shadow-sm">
      <div class="card-body">
        ...
        <div class="mb-2">
          <label class="small text-muted mb-1 fw-bold">Título de la Estructura</label>
          <input 
            type="text" 
            v-model="localData.title" 
            class="form-control form-control-sm fw-semibold"
            placeholder="Ej: Estructura de la RiesGIRD-ACC/Perú"
          >
        </div>
      </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        ...
        <div class="mb-2">
          <label class="small text-muted mb-1 d-block fw-bold">Fotografía Destacada / Diagrama</label>
          ...
          <span class="x-small text-muted d-block mt-2">
            Se recomienda subir el organigrama o diagrama en formato horizontal limpio (ej: PNG transparente o SVG) optimizado para web.
          </span>
        </div>
      </div>
    </div>
...
.media-placeholder { 
  height: 140px; 
  background-size: contain; /* Cambiado a contain para que los diagramas complejos no se recorten */
