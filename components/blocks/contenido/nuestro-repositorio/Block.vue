  ...
  <section v-if="ejes.length" class="repository-block">
    <div class="repository-block__surface">
      <header class="repository-block__header">
        <AtomHeading :level="2" v-if="title" class="repository-block__title">
          {{ title }}
        </AtomHeading>

        <AtomText v-if="introText" class="repository-block__intro">
          {{ introText }}
        </AtomText>
      </header>
      ...
      <div class="repository-block__grid">
        ...
        >
          ...
          <AtomHeading :level="3" v-if="eje.titulo" class="repository-block__card-title">
            {{ eje.titulo }}
          </AtomHeading>

          <AtomText v-if="eje.descripcion" class="repository-block__card-desc">
            {{ eje.descripcion }}
          </AtomText>
        </article>
      </div>
