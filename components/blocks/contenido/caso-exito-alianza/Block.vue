    ...
    <div class="container-fluid-ce">
      <div class="caso-exito-section__panel">
        <div class="header-block" v-if="title">
          <AtomHeading :level="2" class="main-title">{{ title }}</AtomHeading>
        </div>
        ...
        <div class="content-grid">
          <div class="image-wrapper">
            ...
            <div v-else class="placeholder-success-box">
              <div class="placeholder-content">
                ...
                <AtomText class="placeholder-text">Imagen del Caso de Éxito</AtomText>
          ...
          <div class="text-block">
            <AtomHeading :level="3" class="sub-title" v-if="subTitle">
              {{ subTitle }}
            </AtomHeading>

            <div class="description-body">
              <strong class="highlight-label" v-if="highlightLabel">{{ highlightLabel }}</strong>
              <AtomText class="main-paragraph" v-if="text">
                {{ text }}
              </AtomText>
            </div>
          </div>
