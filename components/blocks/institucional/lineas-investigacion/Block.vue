    ...
    <div class="research-lines__outer">
      <div class="research-lines__inner">
        <div class="research-lines__header">
          ...
          <!-- <AtomHeading :level="2" v-if="title" class="research-lines__title">
            <span class="research-lines__title-text">{{ title }}</span>
          </AtomHeading> -->

          <AtomText v-if="introText" class="research-lines__intro">
            {{ introText }}
          </AtomText>
        </div>
        ...
        <div class="research-lines__grid">
          ...
          >
            ...
            <div class="research-lines__card-body">
              <AtomHeading :level="3" v-if="item.title" class="research-lines__card-title">
                {{ item.title }}
              </AtomHeading>

              <AtomText v-if="item.desc" class="research-lines__card-desc">
                {{ item.desc }}
              </AtomText>
            </div>
          </article>
